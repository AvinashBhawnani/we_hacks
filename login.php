...
<body>
	<h1>CAREER GUIDANCE SYSTEM</h1>
		...
		<marquee direction="left" loop="20" scrollamount="10" class="animation" ><h4>User Panel</h4></marquee>
...
<div>
	...
	//Checking is user existing in the database or not
        ...
        if($rows==1){
			...
			header("Location: test.php?q=1.php"); // Redirect user to test.php?q=1.php

            }else{
				header( "refresh:3;url=index.php" ); 
                echo "<script>alert('Your password or username is incorrect.');window.location = 'http://localhost/CareerGuidanceSystem/login.php';</script>";
				}
    }else{

	 ?>
	<form action="" method="post" name="" style="margin-top: 8em;">
		<div id="loginheder"><h2>User login</h2></div>
		...
		<div>
			...
			<p style="font-size: 1em;"><a href="resetpwd.php">Forgot Password</a></p> 
				
		</div>

		<p class="form">Not registered yet? <a href="register.php"> Register Now</a></p>
