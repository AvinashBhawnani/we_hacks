...
<!--The page content have to be brief and unambiguas--> 
  ...
  <table style="margin-top: 8em; width: 60%;margin-left: 20%;">

   <td colspan="4">
        <h3 style="margin-top: 0;color: orange">College List</h3>
...
<tr>
  ...
  <td align="center"><a href="delcol.php?id=<?php echo $row["id"]; ?>"onclick="return confirm('Are you sure?!')" style="margin:0px;background:red;text-decoration: none;padding:5px;color:white;font-weight: bold;">Delete</a></td>
